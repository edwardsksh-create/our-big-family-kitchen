...
import { applyPhotoEdits, setHeroEligible } from '@/app/album/actions';
...
/** Admin crop & rotate, inside the lightbox. The cropper reports the crop
...
function PhotoEditor({ photo, onDone }: { photo: FamilyPhotoFull; onDone: () => void }) {
  ...
  function save() {
    ...
    startTransition(async () => {
      const res = await applyPhotoEdits(photo.id, {
        rotation,
